...
set CLASSPATH=%APP_HOME%\lib\lab1-1.0-SNAPSHOT.jar;%APP_HOME%\lib\slf4j-log4j12-1.7.5.jar;%APP_HOME%\lib\log4j-1.2.17.jar;%APP_HOME%\lib\slf4j-api-1.7.5.jar

@rem Execute lab1
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %LAB1_OPTS%  -classpath "%CLASSPATH%" ru.eltex.Main %CMD_LINE_ARGS%
